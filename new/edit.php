...
include('db/db_con.php');
 ...
 $sql2="insert into propose_definition_tbl(definition_id, word_id, definition, user_id) "
                . "SELECT null, $word_id, '$definition', $user_id from dual "
                . "WHERE NOT EXISTS (SELECT $word_id from propose_definition_tbl "
                . "where definition = '$definition')";   
 
 mysql_query($sql2,$con) or die(mysql_error()); 
 
$msg = "<p style='color:green'>Your definition was successfully saved and waiting for approval by the admin...</p>";
success($msg) ;           
